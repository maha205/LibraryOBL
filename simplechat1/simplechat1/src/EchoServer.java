...
public class EchoServer extends AbstractServer 
{
  ...
  public void handleMessageFromClient(ArrayList<String>  msg, ConnectionToClient client)
{
	  if(msg.get(msg.size()-1) == "GetData") //Return info for this studentID
		  msg = (printCUserData(msg.get(0)));

	  if(msg.get(msg.size()-1) == "Update") //Update info for this studentID
